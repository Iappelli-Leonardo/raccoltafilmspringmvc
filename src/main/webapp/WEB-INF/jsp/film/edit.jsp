	...
	<head>
		...
		<style>
			.ui-autocomplete-loading {
				background: white url("${pageContext.request.contextPath }/assets/img/jqueryUI/anim_16x16.gif") right center no-repeat;
			}
			.error_field {
		        color: red; 
		    }
			...
			<div class="container">
					...
					<div class='card'>
					    ...
					    <div class='card-body'>
								...
								<form:form method="post" modelAttribute="edit_film_attr" action="${pageContext.request.contextPath}/film/saveupdate" novalidate="novalidate" class="row g-3">
								
								<input type="hidden" name="id" value='${edit_film_attr.id}'>
									<div class="col-md-6">
										<label for="titolo" class="form-label">Titolo</label>
										<spring:bind path="titolo">
											<input type="text" name="titolo" id="titolo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il titolo" value="${edit_film_attr.titolo }">
										</spring:bind>
									...
									<div class="col-md-6">
										...
										<spring:bind path="genere">
											<input type="text" name="genere" id="genere" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il genere" value="${edit_film_attr.genere }">
										</spring:bind>
